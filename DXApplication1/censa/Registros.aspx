    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <dx:ASPxComboBox ID="ASPxComboBox1" runat="server" DataSourceID="SqlDataFechaCheck">
                    </dx:ASPxComboBox>
                    <asp:SqlDataSource runat="server" ID="SqlDataFechaCheck" ConnectionString='<%$ ConnectionStrings:bioConnectionString %>' SelectCommand="spGetUserFechasMark" SelectCommandType="StoredProcedure">
                        <SelectParameters>
